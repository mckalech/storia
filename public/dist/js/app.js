...
},{"./box":161,"React":155,"jQuery":159}],161:[function(require,module,exports){
var $ = require('jQuery'),
	React = require('React'),
	Feed = require('./feed'),
...
var Box = React.createClass({displayName: "Box",
	...
	render : function(){
		if(this.state.authorized){
			return (React.createElement(Feed, null))
		}else{
			return(
				React.createElement("span", null, "loging in")
			)
		}
	}
});
...
},{"./feed":162,"React":155,"browser-cookies":156,"jQuery":159}],162:[function(require,module,exports){
	...
	render : function(){
		if(this.state.loaded){
			...
			this.state.posts.forEach(function(item, i, ar){
				feed.push(
					React.createElement(Post, {data: item.objectPreview, key: item.id})
				)
			});
			return (
...
module.exports = Feed;
},{"./post":163,"React":155,"browser-cookies":156,"jQuery":159}],163:[function(require,module,exports){
var React = require('React'),
	$ = require('jQuery'),
...
module.exports = Post;
},{"React":155,"classNames":157,"jQuery":159}]},{},[160]);
